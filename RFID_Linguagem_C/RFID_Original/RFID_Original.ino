...
const unsigned long connectionInterval = 5000; // 10 segundos de intervalo
const unsigned long readInterval = 2000; // 500 milissegundos de intervalo entre leituras
...
void activateSolenoide() {
    ...
    delay(5000); // Ativa por 3 segundos
...
void readAndStoreRequest(const char* url_read) {
    ...
    while (millis() - startTime < 3000) {
        ...
        if (mfrc522.PICC_IsNewCardPresent() && mfrc522.PICC_ReadCardSerial()) {
            ...
            // Chama a função para armazenar o cartão no backend
            ...
            if (httpResponseCode == 200) {
                ...
                turnOnLED("vermelho"); // Alterado para "azul"
                playLongSound();
