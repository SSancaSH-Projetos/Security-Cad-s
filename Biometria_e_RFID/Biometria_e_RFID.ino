...
// URLs do servidor
const char* pegarPosicaoBiometriaUrl = "http://192.168.0.4:8080/acesso/pegarPosicaoBiometria";
const char* modoCadastroEndpointUrl = "http://192.168.0.4:8080/acesso/modoCadastroIniciado";
const char* encerrarCadastroBiometriaUrl = "http://192.168.0.4:8080/acesso/encerrarCadastroBiometria";
const char* verificarBiometriaUrl = "http://192.168.0.4:8080/acesso/biometria";
...
void loop() {
    ...
    if (currentTime - lastConnectionTime >= connectionInterval) {
        ...
        readAndStoreRequest("http://192.168.0.4:8080/acesso/consultar/1/");
    }
}
...
void enviarMensagemBackend(const char* mensagem) {
    if (WiFi.status() == WL_CONNECTED) {
        HTTPClient http;
        String mensagemEndpointUrl = "http://192.168.0.4:8080/acesso/mensagemArduino"; // Defina o URL do endpoint do backend
...
void sendRFIDtoBackend(const char* rfid) {
    HTTPClient http;
    String store_url = "http://192.168.0.4:8080/acesso/armazenar";
